...
// DuoyinziMap 多音字在人名中的标准读音
// 参考《诗云》项目 159 个多音字标准
var DuoyinziMap = map[string]string{
	"华": "huá", "中": "zhōng", "重": "zhòng", "朝": "zhāo",
	"长": "cháng", "行": "xíng", "为": "wéi", "和": "hé",
	"乐": "lè", "了": "liǎo", "几": "jǐ", "发": "fā",
	"得": "dé", "着": "zhe", "都": "dōu", "只": "zhǐ",
	"好": "hǎo", "少": "shǎo", "还": "hái", "差": "chà",
	"相": "xiāng", "将": "jiāng", "教": "jiào", "传": "chuán",
	"调": "tiáo", "曲": "qū", "数": "shù", "应": "yīng",
	"当": "dāng", "会": "huì", "的": "de", "有": "yǒu",
	"大": "dà", "正": "zhèng", "观": "guān", "间": "jiān",
	"空": "kōng", "难": "nán", "与": "yǔ",
	"予": "yǔ", "便": "biàn", "别": "bié", "并": "bìng",
	"曾": "zēng", "处": "chù", "弹": "dàn",
	"度": "dù", "分": "fēn", "否": "fǒu", "更": "gèng",
	"共": "gòng", "过": "guò", "何": "hé", "后": "hòu",
	"胡": "hú", "卷": "juǎn", "决": "jué", "觉": "jué",
	"看": "kàn", "量": "liàng", "令": "lìng", "论": "lùn",
	"没": "méi", "莫": "mò", "那": "nà", "能": "néng",
	"平": "píng", "期": "qī", "然": "rán", "任": "rèn",
	"如": "rú", "若": "ruò", "尚": "shàng", "胜": "shèng",
	"什": "shén", "识": "shí", "实": "shí", "使": "shǐ",
	"是": "shì", "受": "shòu", "思": "sī", "似": "sì",
	"同": "tóng", "万": "wàn", "王": "wáng", "文": "wén",
	"无": "wú", "先": "xiān", "向": "xiàng", "象": "xiàng",
	"心": "xīn", "信": "xìn", "兴": "xīng", "形": "xíng",
	"学": "xué", "言": "yán", "一": "yī", "已": "yǐ",
	"以": "yǐ", "因": "yīn", "于": "yú", "语": "yǔ",
	"元": "yuán", "愿": "yuàn", "云": "yún", "在": "zài",
	"早": "zǎo", "知": "zhī", "之": "zhī", "直": "zhí",
	"至": "zhì", "制": "zhì", "终": "zhōng",
	"主": "zhǔ", "自": "zì", "作": "zuò", "坐": "zuò",
	"殷": "yīn", "燕": "yān", "区": "qū", "仇": "qiú",
	"查": "zhā", "朴": "piáo", "单": "shàn", "解": "xiè",
	"盖": "gě", "叶": "shè", "翟": "zhái", "覃": "qín",
	"臧": "zāng", "乜": "niè", "缪": "miào", "乂": "yì",
	"玥": "yuè", "晟": "shèng", "晔": "yè", "昱": "yù",
	"琪": "qí", "瑾": "jǐn", "瑜": "yú", "瑶": "yáo",
	"婷": "tíng", "彤": "tóng", "泓": "hóng", "涵": "hán",
	"奕": "yì", "翊": "yì", "睿": "ruì", "铭": "míng",
	"钧": "jūn", "钰": "yù", "铮": "zhēng",
	"沐": "mù", "清": "qīng", "婉": "wǎn",
	"岚": "lán", "溪": "xī", "珂": "kē", "珺": "jùn",
	"璇": "xuán", "璋": "zhāng", "璞": "pú",
	"皛": "xiǎo", "旻": "mín", "昶": "chǎng", "晞": "xī",
}

// GetStandardPinyin 获取多音字在姓名中的标准读音
// 如果不是多音字或未收录，返回空字符串
func GetStandardPinyin(char string) string {
	if p, ok := DuoyinziMap[char]; ok {
		return p
	}
	return ""
}
